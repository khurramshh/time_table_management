                        ...
                        <div className='mt-2 mb-2'>
                          {weekdays.map((day, dayIndex) => (
                            <span
                              ...
                              className={`cursor-pointer px-2 py-1 text-[0.500rem] rounded-full mr-1 m-2 ${selectedDays[i][j][dayIndex] ? 'bg-gray-800 text-white' : 'bg-gray-200'
                                }`}
                            >
                              {day}
                            </span>
                    ...
                    <div className='flex flex-col'>
                      <div className='mt-2'>
                        {weekdays.map((day, dayIndex) => (
                          <span
                            key={dayIndex}
                            className={`px-2 py-1 text-sm rounded-sm mr-1 ${
                              selectedDays[i][tableIndex * 4 + j][dayIndex]
                      ...
                      <input
                        type='text'
                        value={subjects[i][tableIndex * 4 + j]}
                        placeholder='Enter subject'
