...
import OfficeFormImg from '../assets/OfficeFormImg.png'
...
const UniversityForm = ({ data, setData }) => {
    ...
    return (
        <div>
            <div className='relative bg-cover bg-center' style={{ backgroundImage: `url(${OfficeImg})` }}>
            ...
            <div className='bg-slate-100 backdrop-blur bg-opacity-35 p-5 shadow-xl'>
                <div className='flex justify-center items-center'>
                    <p className='text-4xl font-bold'>Office Form</p>
                </div>
                    ...
                    <div className='2xl:w-6/12 xl:w-6/12 lg:w-6/12 md:w-6/12 sm:w-full w-full flex justify-center items-center'>
                        ...
                        <div>
                            <div className='flex justify-center items-center h-full'>
                                <img src={OfficeFormImg} alt="Scholl Time Table" className='w-96 h-auto' />
                            </div>

                            <div className='flex justify-center w-11/12'>
                                <p className='text-lg text-center'>Efficiently organize your office schedule with our streamlined form. Input your details, and we'll generate a customized timetable designed to optimize your workday and enhance productivity.</p>
                            </div>
                        </div>
